...
return {
  ...
  view = {
    ...
    { "n", "<localleader>je", actions.goto_file_edit, { desc = "Open the file in the previous tabpage" } },
    { "n", "<localleader>js", actions.goto_file_split, { desc = "Open the file in a new split" } },
    { "n", "<localleader>jt", actions.goto_file_tab, { desc = "Open the file in a new tabpage" } },
    { "n", "<localleader>f", actions.focus_files, { desc = "Bring focus to the file panel" } },
    { "n", "<localleader>p", actions.toggle_files, { desc = "Toggle the file panel." } },
    { "n", "<localleader>ld", actions.cycle_layout, { desc = "Cycle through available layouts." } },
  ...
  file_panel = {
    ...
    { "n", "<localleader>p", actions.toggle_files, { desc = "Toggle the file panel." } },
    { "n", "<localleader>ld", actions.cycle_layout, { desc = "Cycle through available layouts." } },
    { "n", "<localleader>lp", actions.listing_style, { desc = "Toggle between 'list' and 'tree' views" } },
